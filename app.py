...
نکته مهم: قبل از اجرا باید مدل خود را در Hugging Face Hub آپلود کرده باشی
و مقدار MODEL_REPO_ID زیر را با repo_id واقعی خودت جایگزین کنی.
مثال: "sajjad007/snapfood-parsbert-sentiment"
"""
...
# ==========================================
# CSS برای راست‌چین کردن کامل صفحه
# ==========================================
st.markdown(
    """
    <style>
...
# ==========================================
# مسیر مدل روی Hugging Face Hub
# ==========================================
MODEL_REPO_ID = "sajjad007/snapfood-parsbert-sentiment"  # <-- این را با repo_id خودت جایگزین کن
